                    ...
                    >
                      <TableBody>
                        ...
                        <TableRow>
                          ...
                          <TableCell>{Data.formatString(row.redeemerOutputScript)}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>TxHash</TableCell>
                          <TableCell>{Data.formatString(row.redemptionTxHash)}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>TreasuryFee</TableCell>
                          <TableCell>{row.treasuryFee} <span className={styles.span_note}>%</span></TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>TxMaxFee</TableCell>
                          <TableCell>{row.txMaxFee} <span className={styles.span_note}>BTC</span></TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>Completed TxHash</TableCell>
                          <TableCell>{Data.formatString(row.completedTxHash)}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>Redeem Timestamp</TableCell>
                          <TableCell>{Data.calculateTimeMoment(row.redemptionTimestamp)}</TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
                  </div>
