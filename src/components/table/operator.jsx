      ...
      <TableHead>
        <TableRow>
          {columns.map((headCell) => (
            ...
            >
              {headCell.accessor == "tBTCAuthorizedAmount" ||
              headCell.accessor == "randomBeaconAuthorizedAmount" ||
              headCell.accessor == "stakedAmount" ||
              headCell.accessor == "availableReward" ||
              headCell.accessor == "stakedAt" ||
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          {/*</TableCell>*/}
          <TableCell align="left">{row.misbehavedCount}</TableCell>
          <TableCell align="left">
