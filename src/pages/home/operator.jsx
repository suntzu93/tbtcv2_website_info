      ...
      <div className={styles.operator_detail_header}>
        ...
        <div className={styles.operator_detail_header_value}>
          <div className={styles.operator_detail_header_value_item}>
            ...
            <div className={styles.operator_detail_header_value_item_lable_sub}>
              total
            </div>
            <div>
            ...
            <div>
              <div>
                {Data.formatWeiDecimalNoSurplus(
                  stats?.totalTBTCAuthorizedAmount
                )}
        ...
        <div className={styles.operator_detail_header_value}>
          <div className={styles.operator_detail_header_value_item}>
            ...
            <div>
              <div>
                {Data.formatWeiDecimalNoSurplus(
                  stats?.totalRandomBeaconAuthorizedAmount
                )}
                <span className={styles.span_t_token}>{" T"}</span>
              </div>
            </div>
        ...
        <div className={styles.operator_detail_header_value}>
          <div className={styles.operator_detail_header_value_item}>
            ...
            <div>
              <div>
                {Data.formatWeiDecimalNoSurplus(stats?.totalStaked)}
                <span className={styles.span_t_token}>{" T"}</span>
              </div>
            </div>
          </div>
